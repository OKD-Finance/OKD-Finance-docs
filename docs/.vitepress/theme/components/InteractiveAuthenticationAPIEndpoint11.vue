...
async function authnotificationsidRequest() {
  try {
    const data = {
      id: &#39;example_id&#39;,
    };
    
    const response = await apiClient.put(&#39;/auth/notifications/{id}&#39;, data);
...
// Usage
authnotificationsidRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">notification is marked as viewed.</span>
              </div>
              <div class="code-block">
                <pre>{
  &quot;success&quot;: true,
  &quot;message&quot;: &quot;notification is marked as viewed.&quot;,
