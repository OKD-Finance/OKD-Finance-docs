...
async function userflagsRequest() {
  try {
    ...
    const response = await apiClient.put(&#39;/user/flags&#39;, data);
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                ...
                <select v-model="testData.notifications" class="test-input">
          ...
          <div class="form-group">
                ...
                <select v-model="testData.marketing" class="test-input">
                  <option :value="true">True</option>
                  <option :value="false">False</option>
                </select>
              </div>
          <div class="form-group">
                <label>Privacy</label>
                <input v-model="testData.privacy" type="text" placeholder="example_privacy" class="test-input" />
              </div>
...
const testEndpoint = async () => {
  try {
    ...
    const requestBody = {
      ...
      marketing: testData.marketing,
      privacy: testData.privacy
    }
