...
async function authpasswordrestorecodeRequest() {
  try {
    const data = {
      code: &#39;example_code&#39;,
    };
    
    const response = await apiClient.get(&#39;/auth/password/restore/{code}&#39;, data);
...
// Usage
authpasswordrestorecodeRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">result of checking</span>
              </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                <label>Code</label>
                <input v-model="testData.code" type="text" placeholder="example_code" class="test-input" />
              </div>
