...
async function kycwebhookRequest() {
  try {
    const response = await apiClient.post(&#39;/kyc/webhook&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">webhook message is received and successfully handled</span>
              </div>
