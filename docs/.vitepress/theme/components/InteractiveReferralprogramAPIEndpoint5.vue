...
async function referrallinklinkRequest() {
  try {
    const data = {
      link: &#39;example_link&#39;,
    };
    
    const response = await apiClient.get(&#39;/referral/link/{link}&#39;, data);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">Link attributes</span>
              </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                <label>Link</label>
                <input v-model="testData.link" type="text" placeholder="example_link" class="test-input" />
              </div>
