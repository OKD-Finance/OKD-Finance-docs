        ...
        <div class="api-section">
          ...
          <div class="code-examples">
            <div class="code-tabs">
              ...
              <pre>curl -X PUT &quot;https://develop.okd.finance/api/preferences/symbols/{pref_key}/{symbol_id}&quot; \
...
async function preferencessymbolsprefkeysymbolidRequest() {
  try {
    ...
    const response = await apiClient.put(&#39;/preferences/symbols/{pref_key}/{symbol_id}&#39;, data);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">symbol is added</span>
              </div>
              <div class="code-block">
                <pre>{
  &quot;success&quot;: true,
  &quot;message&quot;: &quot;symbol is added&quot;,
