...
async function authregisterRequest() {
  try {
    const data = {
      email: &#39;example_email&#39;,
      password: &#39;example_password&#39;,
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          ...
          <div class="form-group">
                ...
                <input v-model="testData.firstName" type="text" placeholder="example_firstName" class="test-input" />
              </div>
          <div class="form-group">
                <label>LastName</label>
                <input v-model="testData.lastName" type="text" placeholder="example_lastName" class="test-input" />
              </div>
