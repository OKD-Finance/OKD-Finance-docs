...
async function authsigninresendRequest() {
  try {
    const response = await apiClient.put(&#39;/auth/sign-in/resend&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">operation response</span>
              </div>
