        ...
        <div class="api-section" v-if="hasParameters">
          ...
          <div class="param-list">
            ...
            <div class="param-item required">
              ...
              <span class="param-type">string</span>
              <span class="param-desc">Currency. Examples: BTC, ETH, LTC, BCH, BNB, EOS, XRP, XLM, LINK, DOT, YFI, SOL,
...
XAU, BITS, SATS
            ...
            <div class="param-item required">
              <code class="param-name">preview</code>
              <span class="param-type">bool</span>
              <span class="param-desc">Preview. 24 points in the last 24 hours interval
</span>
            </div>
            <div class="param-item required">
...
async function datasourcepriceshistoryRequest() {
  try {
    const data = {
      asset_id: &#39;example_asset_id&#39;,
      currency: &#39;example_currency&#39;,
    ...
    const response = await apiClient.get(&#39;/datasource/prices/history&#39;, data);
...
// Usage
datasourcepriceshistoryRequest();</pre>
            </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                ...
                <input v-model="testData.asset_id" type="text" placeholder="example_asset_id" class="test-input" />
              </div>
          <div class="form-group">
                <label>Currency</label>
                <input v-model="testData.currency" type="text" placeholder="example_currency" class="test-input" />
              </div>
          <div class="form-group">
                <label>Source_id</label>
                <input v-model="testData.source_id" type="text" placeholder="example_source_id" class="test-input" />
              </div>
          <div class="form-group">
                <label>Preview</label>
                <input v-model="testData.preview" type="text" placeholder="example_preview" class="test-input" />
              </div>
          <div class="form-group">
                <label>Interval</label>
                <input v-model="testData.interval" type="text" placeholder="example_interval" class="test-input" />
              </div>
          <div class="form-group">
                <label>From</label>
...
<style scoped>
/* Modern Bybit-style API Explorer Design */
