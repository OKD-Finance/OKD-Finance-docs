            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab2 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X DELETE &quot;https://develop.okd.finance/api/spot/orders&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{}&#x27;</pre>
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab3 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X GET &quot;https://develop.okd.finance/api/spot/orders/history&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{&quot;limit&quot;:&quot;example&quot;,&quot;category&quot;:&quot;example&quot;}&#x27;</pre>
                  </div>
                </div>
          ...
          <div class="endpoint-testing">
            ...
            <div class="test-section">
              ...
              <div class="form-group">
                ...
                <input v-model="testData3.category" type="text" placeholder="example_category" class="test-input" />
              </div>
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab4 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X GET &quot;https://develop.okd.finance/api/spot/orders/open&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{&quot;category&quot;:&quot;example&quot;,&quot;limit&quot;:&quot;example&quot;}&#x27;</pre>
                  </div>
                </div>
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab5 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X GET &quot;https://develop.okd.finance/api/spot/trades/history&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{&quot;category&quot;:&quot;example&quot;}&#x27;</pre>
                  </div>
                </div>
...
const testData3 = reactive({ limit: 'example_limit', category: 'example_category' })
const testData4 = reactive({ category: 'example_category', limit: 'example_limit' })
const testData5 = reactive({ category: 'example_category' })
...
const testEndpoint3 = async () => {
  try {
    ...
    const requestBody = {
      ...
      category: testData3.category
    }

    const fullUrl = `${authValues.apiBaseUrl}/spot/orders/history`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const testEndpoint4 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/spot/orders/open`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const testEndpoint5 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/spot/trades/history`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const codeExamples = {
  ...
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{}'`,
    2: `curl -X DELETE "https://develop.okd.finance/api/spot/orders" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{}'`,
    3: `curl -X GET "https://develop.okd.finance/api/spot/orders/history" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{"limit":"example","category":"example"}'`,
    4: `curl -X GET "https://develop.okd.finance/api/spot/orders/open" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{"category":"example","limit":"example"}'`,
    5: `curl -X GET "https://develop.okd.finance/api/spot/trades/history" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{"category":"example"}'`
...
func createspotorder() error {
    url := "https://develop.okd.finance/api/spot/orders"
    
    requestData := CreatespotorderRequest{
...
func main() {
    if err := createspotorder(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`,
    2: `package main
...
func cancelspotorder() error {
    url := "https://develop.okd.finance/api/spot/orders"
    
    requestData := CancelspotorderRequest{
...
func main() {
    if err := cancelspotorder(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`,
    3: `package main
...
type ListspotordershistoryRequest struct {
    Limit string \`json:"limit"\`\n    Category string \`json:"category"\`
}

func listspotordershistory() error {
    url := "https://develop.okd.finance/api/spot/orders/history"
    
    requestData := ListspotordershistoryRequest{
        Limit: "example",\n        Category: "example",
    }
...
func main() {
    if err := listspotordershistory(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`,
    4: `package main
...
type ListspotopenordersRequest struct {
    Category string \`json:"category"\`\n    Limit string \`json:"limit"\`
}

func listspotopenorders() error {
    url := "https://develop.okd.finance/api/spot/orders/open"
    
    requestData := ListspotopenordersRequest{
        Category: "example",\n        Limit: "example",
    }
...
func main() {
    if err := listspotopenorders(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`,
    5: `package main
...
type ListspottradeshistoryRequest struct {
    Category string \`json:"category"\`
}

func listspottradeshistory() error {
    url := "https://develop.okd.finance/api/spot/trades/history"
    
    requestData := ListspottradeshistoryRequest{
        Category: "example",
    }
...
func main() {
    if err := listspottradeshistory(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`
  },
  typescript: {
    1: `interface CreatespotorderRequest {
...
main();`,
    2: `interface CancelspotorderRequest {
...
main();`,
    3: `interface ListspotordershistoryRequest {
  limit: string;\n  category: string;
}

async function listspotordershistory(
  baseUrl: string,
  accessToken: string,
  data: ListspotordershistoryRequest
): Promise<any> {
  const response = await fetch(\`\${baseUrl}/spot/orders/history\`, {
    method: 'GET',
    headers: {
      'Authorization': \`Bearer \${accessToken}\`,
      'Content-Type': 'application/json',
...
async function main() {
  try {
    const result = await listspotordershistory(
      'https://develop.okd.finance/api',
      'YOUR_ACCESS_TOKEN',
      {
        limit: "example",\n        category: "example",
...
main();`,
    4: `interface ListspotopenordersRequest {
  category: string;\n  limit: string;
}

async function listspotopenorders(
  baseUrl: string,
  accessToken: string,
  data: ListspotopenordersRequest
): Promise<any> {
  const response = await fetch(\`\${baseUrl}/spot/orders/open\`, {
    method: 'GET',
    headers: {
      'Authorization': \`Bearer \${accessToken}\`,
      'Content-Type': 'application/json',
...
async function main() {
  try {
    const result = await listspotopenorders(
      'https://develop.okd.finance/api',
      'YOUR_ACCESS_TOKEN',
      {
        category: "example",\n        limit: "example",
...
main();`,
    5: `interface ListspottradeshistoryRequest {
  category: string;
}

async function listspottradeshistory(
  baseUrl: string,
  accessToken: string,
  data: ListspottradeshistoryRequest
): Promise<any> {
  const response = await fetch(\`\${baseUrl}/spot/trades/history\`, {
    method: 'GET',
    headers: {
      'Authorization': \`Bearer \${accessToken}\`,
      'Content-Type': 'application/json',
...
async function main() {
  try {
    const result = await listspottradeshistory(
      'https://develop.okd.finance/api',
      'YOUR_ACCESS_TOKEN',
      {
        category: "example",
...
function createspotorder($baseUrl, $accessToken, $data) {
...
function cancelspotorder($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/spot/orders';
...
function listspotordershistory($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/spot/orders/history';
...
function listspotopenorders($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/spot/orders/open';
...
function listspottradeshistory($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/spot/trades/history';
...
! Need access token in bearer token authorization"""
    url = f"{base_url}/spot/orders/history"
...
! Need access token in bearer token authorization"""
    url = f"{base_url}/spot/trades/history"
