...
async function referralexportRequest() {
  try {
    const data = {
      from: &#39;example_from&#39;,
      to: &#39;example_to&#39;,
    ...
    const response = await apiClient.get(&#39;/referral/export&#39;, data);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">.xlsx file with export</span>
              </div>
              <div class="code-block">
                <pre>{
  &quot;success&quot;: true,
  &quot;message&quot;: &quot;.xlsx file with export&quot;,
