...
async function referralpercentsRequest() {
  try {
    const response = await apiClient.get(&#39;/referral/percents&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">Percents</span>
              </div>
