...
async function configassetsnetworksRequest() {
  try {
    const data = {
      limit: &#39;example_limit&#39;,
      offset: &#39;example_offset&#39;,
    ...
    const response = await apiClient.get(&#39;/config/assets/networks&#39;, data);
...
// Usage
configassetsnetworksRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">list networks</span>
              </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          ...
          <div class="form-group">
                ...
                <input v-model="testData.activityType" type="text" placeholder="example_activityType" class="test-input" />
              </div>
          <div class="form-group">
                <label>ActivityEnabled</label>
                <input v-model="testData.activityEnabled" type="text" placeholder="example_activityEnabled" class="test-input" />
              </div>
          <div class="form-group">
                <label>SortBy</label>
...
const testEndpoint = async () => {
  try {
    ...
    const requestBody = {
      ...
      activityEnabled: testData.activityEnabled,
