...
async function authlocaleRequest() {
  try {
    const response = await apiClient.put(&#39;/auth/locale&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">locale successfully changed</span>
              </div>
