...
async function configwithdrawalRequest() {
  try {
    const response = await apiClient.get(&#39;/config/withdrawal&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">withdrawal settings</span>
              </div>
