...
async function v5assettransferquerytransfercoinlistRequest() {
  try {
    const response = await apiClient.get(&#39;/v5/asset/transfer/query-transfer-coin-list&#39;);
...
// Usage
v5assettransferquerytransfercoinlistRequest();</pre>
            </div>
