...
async function wallettransactionsdepositRequest() {
  try {
    const data = {
      coin: &#39;example_coin&#39;,
      chainType: &#39;example_chainType&#39;,
    ...
    const response = await apiClient.get(&#39;/wallet/transactions/deposit&#39;, data);
...
// Usage
wallettransactionsdepositRequest();</pre>
            </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          ...
          <div class="form-group">
                ...
                <input v-model="testData.chainType" type="text" placeholder="example_chainType" class="test-input" />
              </div>
