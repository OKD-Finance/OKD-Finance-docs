...
async function v5assetwithdrawqueryrecordRequest() {
  try {
    const response = await apiClient.get(&#39;/v5/asset/withdraw/query-record&#39;);
...
// Usage
v5assetwithdrawqueryrecordRequest();</pre>
            </div>
