...
async function operationsuuidcancelRequest() {
  try {
    const data = {
      uuid: &#39;example_uuid&#39;,
    };
    
    const response = await apiClient.put(&#39;/operations/{uuid}/cancel&#39;, data);
...
// Usage
operationsuuidcancelRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">operation cancelled</span>
              </div>
