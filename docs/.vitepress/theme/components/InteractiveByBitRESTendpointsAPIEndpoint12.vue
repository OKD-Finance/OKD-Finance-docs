...
async function v5assetwithdrawwithdrawableamountRequest() {
  try {
    const response = await apiClient.get(&#39;/v5/asset/withdraw/withdrawable-amount&#39;);
...
// Usage
v5assetwithdrawwithdrawableamountRequest();</pre>
            </div>
