...
async function usernotificationsRequest() {
  try {
    const data = {
      email: &#39;example_email&#39;,
      push: &#39;example_push&#39;,
    ...
    if hasattr(e, &#39;response&#39;) and e.response is not None:
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          ...
          <div class="form-group">
                <label>Push</label>
                <select v-model="testData.push" class="test-input">
                  <option :value="true">True</option>
                  <option :value="false">False</option>
                </select>
              </div>
          <div class="form-group">
                <label>Sms</label>
                <select v-model="testData.sms" class="test-input">
                  <option :value="true">True</option>
                  <option :value="false">False</option>
                </select>
              </div>
