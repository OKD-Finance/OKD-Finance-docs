...
async function v5assettransferqueryaccountcoinbalanceRequest() {
  try {
    const response = await apiClient.get(&#39;/v5/asset/transfer/query-account-coin-balance&#39;);
...
// Usage
v5assettransferqueryaccountcoinbalanceRequest();</pre>
            </div>
