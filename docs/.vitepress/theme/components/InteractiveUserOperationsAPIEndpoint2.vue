...
async function operationsuuidconfirmRequest() {
  try {
    const data = {
      uuid: &#39;example_uuid&#39;,
    };
    
    const response = await apiClient.put(&#39;/operations/{uuid}/confirm&#39;, data);
...
// Usage
operationsuuidconfirmRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">operation completed</span>
              </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                <label>Uuid</label>
                <input v-model="testData.uuid" type="text" placeholder="example_uuid" class="test-input" />
              </div>
