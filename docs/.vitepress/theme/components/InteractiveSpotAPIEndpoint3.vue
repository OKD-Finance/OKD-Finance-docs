...
async function spotordershistoryRequest() {
  try {
    const data = {
      limit: &#39;example_limit&#39;,
      category: &#39;example_category&#39;,
    ...
    const response = await apiClient.get(&#39;/spot/orders/history&#39;, data);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">list spot orders history</span>
              </div>
