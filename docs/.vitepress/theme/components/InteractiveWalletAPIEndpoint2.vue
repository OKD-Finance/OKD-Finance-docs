...
async function wallettotalbalanceRequest() {
  try {
    const response = await apiClient.get(&#39;/wallet/total-balance&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">user total balance</span>
              </div>
