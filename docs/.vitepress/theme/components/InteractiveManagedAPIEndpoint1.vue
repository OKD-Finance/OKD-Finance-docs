...
async function managedsigninRequest() {
  try {
    const response = await apiClient.post(&#39;/managed/sign-in&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">pair of tokens</span>
              </div>
