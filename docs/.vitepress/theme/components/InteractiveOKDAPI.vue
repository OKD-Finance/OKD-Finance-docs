              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab1 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X POST &quot;https://develop.okd.finance/api/okd/feedback&quot; \
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab2 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X POST &quot;https://develop.okd.finance/api/okd/private-feedback&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{}&#x27;</pre>
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab3 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X POST &quot;https://develop.okd.finance/api/okd/question&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{}&#x27;</pre>
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab4 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X GET &quot;https://develop.okd.finance/api/okd/topassets&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
...
const testData4 = reactive({ category: 'example_category' })
...
const testEndpoint1 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/okd/feedback`
    const headers = {
...
const testEndpoint2 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/okd/private-feedback`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const testEndpoint3 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/okd/question`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const testEndpoint4 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/okd/topassets`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const codeExamples = {
  curl: {
    1: `curl -X POST "https://develop.okd.finance/api/okd/feedback" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{}'`,
    2: `curl -X POST "https://develop.okd.finance/api/okd/private-feedback" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{}'`,
    3: `curl -X POST "https://develop.okd.finance/api/okd/question" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{}'`,
    4: `curl -X GET "https://develop.okd.finance/api/okd/topassets" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{"category":"example"}'`
...
func sendfeedback() error {
    url := "https://develop.okd.finance/api/okd/feedback"
    
    requestData := SendfeedbackRequest{
...
type SendprivatefeedbackRequest struct {

}

func sendprivatefeedback() error {
    url := "https://develop.okd.finance/api/okd/private-feedback"
    
    requestData := SendprivatefeedbackRequest{
...
func main() {
    if err := sendprivatefeedback(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`,
    3: `package main
...
func sendquestion() error {
    url := "https://develop.okd.finance/api/okd/question"
    
    requestData := SendquestionRequest{
...
func listtopassets() error {
    url := "https://develop.okd.finance/api/okd/topassets"
    
    requestData := ListtopassetsRequest{
        Category: "example",
    }
...
func main() {
    if err := listtopassets(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`
  },
  typescript: {
    1: `interface SendfeedbackRequest {
...
async function sendfeedback(
  ...
  const response = await fetch(\`\${baseUrl}/okd/feedback\`, {
    method: 'POST',
    headers: {
...
main();`,
    2: `interface SendprivatefeedbackRequest {
...
async function sendprivatefeedback(
  baseUrl: string,
  accessToken: string,
  data: SendprivatefeedbackRequest
): Promise<any> {
  const response = await fetch(\`\${baseUrl}/okd/private-feedback\`, {
    method: 'POST',
    headers: {
      'Authorization': \`Bearer \${accessToken}\`,
      'Content-Type': 'application/json',
...
async function main() {
  try {
    const result = await sendprivatefeedback(
      'https://develop.okd.finance/api',
      'YOUR_ACCESS_TOKEN',
      {
...
main();`,
    3: `interface SendquestionRequest {
...
async function sendquestion(
  ...
  const response = await fetch(\`\${baseUrl}/okd/question\`, {
    method: 'POST',
    headers: {
      'Authorization': \`Bearer \${accessToken}\`,
      'Content-Type': 'application/json',
...
main();`,
    4: `interface ListtopassetsRequest {
  category: string;
}

async function listtopassets(
  baseUrl: string,
  accessToken: string,
  data: ListtopassetsRequest
): Promise<any> {
  const response = await fetch(\`\${baseUrl}/okd/topassets\`, {
    method: 'GET',
    headers: {
      'Authorization': \`Bearer \${accessToken}\`,
      'Content-Type': 'application/json',
...
async function main() {
  try {
    const result = await listtopassets(
      'https://develop.okd.finance/api',
      'YOUR_ACCESS_TOKEN',
      {
        category: "example",
...
function sendfeedback($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/okd/feedback';
...
function sendprivatefeedback($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/okd/private-feedback';
...
function sendquestion($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/okd/question';
...
function listtopassets($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/okd/topassets';
...
def sendprivatefeedback(
    base_url: str,
    access_token: str,
    data: Dict[str, Any]
) -> Dict[str, Any]:
    """! Need access token in bearer token authorization"""
    url = f"{base_url}/okd/private-feedback"
