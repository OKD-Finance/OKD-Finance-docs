...
async function v5assettransferqueryaccountcoinsbalanceRequest() {
  try {
    const response = await apiClient.get(&#39;/v5/asset/transfer/query-account-coins-balance&#39;);
...
// Usage
v5assettransferqueryaccountcoinsbalanceRequest();</pre>
            </div>
