...
https://bybit-exchange.github.io/docs/v5/market/instrument</p>
        ...
        <div class="api-section" v-if="hasParameters">
          ...
          <div class="param-list">
            ...
            <div class="param-item required">
              <code class="param-name">favourites</code>
              <span class="param-type">string</span>
              <span class="param-desc">Logical 'true' of 'false'. If set to 'true' select only favourites symbols.
</span>
            </div>
            <div class="param-item required">
...
async function configspotlitesymbolsRequest() {
  try {
    const data = {
      category: &#39;example_category&#39;,
      baseCoin: &#39;example_baseCoin&#39;,
    ...
    const response = await apiClient.get(&#39;/config/spot/lite-symbols&#39;, data);
...
// Usage
configspotlitesymbolsRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">create spot order</span>
              </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          ...
          <div class="form-group">
                ...
                <input v-model="testData.baseCoin" type="text" placeholder="example_baseCoin" class="test-input" />
              </div>
          <div class="form-group">
                <label>TradingEnabled</label>
                <input v-model="testData.tradingEnabled" type="text" placeholder="example_tradingEnabled" class="test-input" />
              </div>
          <div class="form-group">
                <label>Limit</label>
          ...
          <div class="form-group">
                ...
                <input v-model="testData.favourites" type="text" placeholder="example_favourites" class="test-input" />
              </div>
          <div class="form-group">
                <label>SortBy</label>
          ...
          <div class="form-group">
                <label>Search</label>
                <input v-model="testData.search" type="text" placeholder="example_search" class="test-input" />
              </div>
...
const testEndpoint = async () => {
  try {
    ...
    const requestBody = {
      ...
      baseCoin: testData.baseCoin,
      tradingEnabled: testData.tradingEnabled,
      limit: testData.limit,
      offset: testData.offset,
      favourites: testData.favourites,
