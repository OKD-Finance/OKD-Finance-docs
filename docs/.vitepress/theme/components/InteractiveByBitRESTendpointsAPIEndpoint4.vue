...
async function v5assetdepositqueryinternalrecordRequest() {
  try {
    const response = await apiClient.get(&#39;/v5/asset/deposit/query-internal-record&#39;);
...
// Usage
v5assetdepositqueryinternalrecordRequest();</pre>
            </div>
