...
// API Methods
    ...
    async list_assets() {
      this.loading['list_assets'] = true;
      this.error['list_assets'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/config/assets`, {
          method: 'GET',
          headers,
        ...
        this.responses['list_assets'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['list_assets'] = err.message;
      } finally {
        this.loading['list_assets'] = false;
      }
    },
    async list_assets_networks() {
      this.loading['list_assets_networks'] = true;
      this.error['list_assets_networks'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/config/assets/networks`, {
          method: 'GET',
          headers,
        ...
        const data = await response.json();
        this.responses['list_assets_networks'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['list_assets_networks'] = err.message;
      } finally {
        this.loading['list_assets_networks'] = false;
      }
    },
    async get_global_flags() {
      this.loading['get_global_flags'] = true;
      this.error['get_global_flags'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/config/flags`, {
          method: 'GET',
          headers,
        ...
        const data = await response.json();
        this.responses['get_global_flags'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['get_global_flags'] = err.message;
      } finally {
        this.loading['get_global_flags'] = false;
      }
    },
    async list_spot_lite_symbols() {
      this.loading['list_spot_lite_symbols'] = true;
      this.error['list_spot_lite_symbols'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/config/spot/lite-symbols`, {
          method: 'GET',
          headers,
        ...
        const data = await response.json();
        this.responses['list_spot_lite_symbols'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['list_spot_lite_symbols'] = err.message;
      } finally {
        this.loading['list_spot_lite_symbols'] = false;
      }
    },
    async list_spot_symbols() {
      this.loading['list_spot_symbols'] = true;
      this.error['list_spot_symbols'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/config/spot/symbols`, {
          method: 'GET',
          headers,
        ...
        const data = await response.json();
        this.responses['list_spot_symbols'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['list_spot_symbols'] = err.message;
      } finally {
        this.loading['list_spot_symbols'] = false;
      }
    },
    async get_withdrawal_config() {
      this.loading['get_withdrawal_config'] = true;
      this.error['get_withdrawal_config'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/config/withdrawal`, {
          method: 'GET',
          headers,
        ...
        const data = await response.json();
        this.responses['get_withdrawal_config'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['get_withdrawal_config'] = err.message;
      } finally {
        this.loading['get_withdrawal_config'] = false;
      }
    },
</script>
