...
async function v5assetdepositqueryallowedlistRequest() {
  try {
    const response = await apiClient.get(&#39;/v5/asset/deposit/query-allowed-list&#39;);
...
// Usage
v5assetdepositqueryallowedlistRequest();</pre>
            </div>
