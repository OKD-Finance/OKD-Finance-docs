...
async function kyctokenRequest() {
  try {
    const data = {
      kind: &#39;example_kind&#39;,
    };
    
    const response = await apiClient.get(&#39;/kyc/token&#39;, data);
...
try:
                ...
                <pre>[
  {
    ...
    &quot;url&quot;: &quot;https://kyc-forms-new.amlbot.com/0da19511064d144d091a46a0f4df1998f563&quot;
  }
]</pre>
              </div>
            </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                <label>Kind</label>
                <input v-model="testData.kind" type="text" placeholder="example_kind" class="test-input" />
              </div>
