...
async function spotorderRequest() {
  try {
    const data = {
      symbol: &#39;example_symbol&#39;,
      side: &#39;example_side&#39;,
    ...
    const response = await apiClient.post(&#39;/spot/order&#39;, data);
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          ...
          <div class="form-group">
                ...
                <input v-model="testData.quantity" type="text" placeholder="example_quantity" class="test-input" />
              </div>
          <div class="form-group">
                <label>Price</label>
