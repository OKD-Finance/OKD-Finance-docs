<template>
        ...
        <div class="endpoint-layout">
          <div class="endpoint-docs">
            ...
            <div class="endpoint-info">
              <h3 class="endpoint-title">📋 GET /datasource/coin-info</h3>
          ...
          <div class="endpoint-testing">
            ...
            <div class="test-section">
              <div class="form-group">
                ...
                <input v-model="testData1.asset_id" type="text" placeholder="example_asset_id" class="test-input" />
              </div>
              <div class="form-group">
                <label>Source_id</label>
                <input v-model="testData1.source_id" type="text" placeholder="example_source_id" class="test-input" />
              </div>
  ...
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{&quot;datasource&quot;:&quot;example&quot;,&quot;search&quot;:&quot;example&quot;,&quot;sortBy&quot;:&quot;example&quot;,&quot;fullness&quot;:&quot;example&quot;,&quot;limit&quot;:&quot;example&quot;,&quot;offset&quot;:&quot;example&quot;}&#x27;</pre>
                  </div>
                </div>
          ...
          <div class="endpoint-testing">
            ...
            <div class="test-section">
              <div class="form-group">
                ...
                <input v-model="testData2.datasource" type="text" placeholder="example_datasource" class="test-input" />
              </div>
              <div class="form-group">
                <label>Search</label>
              ...
              <div class="form-group">
                ...
                <input v-model="testData2.fullness" type="text" placeholder="example_fullness" class="test-input" />
              </div>
              <div class="form-group">
                <label>Limit</label>
      ...
      <section id="endpoint-3" class="endpoint-section">
        <div class="endpoint-layout">
          <div class="endpoint-docs">
            ...
            <div class="endpoint-info">
              <h3 class="endpoint-title">📋 GET /datasource/prices/history</h3>
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab3 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X GET &quot;https://develop.okd.finance/api/datasource/prices/history&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{&quot;asset_id&quot;:&quot;example&quot;,&quot;source_id&quot;:&quot;example&quot;,&quot;interval&quot;:&quot;example&quot;,&quot;from&quot;:&quot;example&quot;,&quot;to&quot;:&quot;example&quot;}&#x27;</pre>
                  </div>
                </div>
          ...
          <div class="endpoint-testing">
            ...
            <div class="test-section">
              <div class="form-group">
                <label>Asset_id</label>
                <input v-model="testData3.asset_id" type="text" placeholder="example_asset_id" class="test-input" />
              </div>
              <div class="form-group">
                <label>Source_id</label>
                <input v-model="testData3.source_id" type="text" placeholder="example_source_id" class="test-input" />
              </div>
              <div class="form-group">
                <label>Interval</label>
                <input v-model="testData3.interval" type="text" placeholder="example_interval" class="test-input" />
              </div>
              <div class="form-group">
                <label>From</label>
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab4 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X GET &quot;https://develop.okd.finance/api/datasource/prices/sources&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{}&#x27;</pre>
...
const testData1 = reactive({ asset_id: 'example_asset_id', source_id: 'example_source_id' })
const testData2 = reactive({ datasource: 'example_datasource', search: 'example_search', sortBy: 'example_sortBy', fullness: 'example_fullness', limit: 'example_limit', offset: 'example_offset' })
const testData3 = reactive({ asset_id: 'example_asset_id', source_id: 'example_source_id', interval: 'example_interval', from: 'example_from', to: 'example_to' })
...
const testEndpoint1 = async () => {
  try {
    ...
    const requestBody = {
      asset_id: testData1.asset_id,
      source_id: testData1.source_id
    }

    const fullUrl = `${authValues.apiBaseUrl}/datasource/coin-info`
    const headers = {
...
const testEndpoint2 = async () => {
  try {
    ...
    const requestBody = {
      datasource: testData2.datasource,
      search: testData2.search,
      sortBy: testData2.sortBy,
      fullness: testData2.fullness,
      limit: testData2.limit,
      offset: testData2.offset
    }

    const fullUrl = `${authValues.apiBaseUrl}/datasource/prices/assets`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const testEndpoint3 = async () => {
  try {
    ...
    const requestBody = {
      asset_id: testData3.asset_id,
      source_id: testData3.source_id,
      interval: testData3.interval,
      from: testData3.from,
      to: testData3.to
    }

    const fullUrl = `${authValues.apiBaseUrl}/datasource/prices/history`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const testEndpoint4 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/datasource/prices/sources`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
