...
async function authpasswordrestoreRequest() {
  try {
    const response = await apiClient.put(&#39;/auth/password/restore&#39;);
...
// Usage
authpasswordrestoreRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">finish successful</span>
              </div>
