              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab1 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X POST &quot;https://develop.okd.finance/api/managed/sign-in&quot; \
            ...
            <div class="api-section">
              ...
              <div class="code-examples">
                ...
                <div v-show="activeCodeTab2 === 'cURL'" class="code-block-container">
                  ...
                  <div class="code-block">
                    <pre>curl -X POST &quot;https://develop.okd.finance/api/managed/sign-up&quot; \
  -H &quot;Authorization: Bearer YOUR_ACCESS_TOKEN&quot; \
  -H &quot;Content-Type: application/json&quot; \
  -H &quot;Fingerprint: YOUR_FINGERPRINT&quot; \
  -d &#x27;{}&#x27;</pre>
...
const testEndpoint1 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/managed/sign-in`
    const headers = {
...
const testEndpoint2 = async () => {
  try {
    ...
    const fullUrl = `${authValues.apiBaseUrl}/managed/sign-up`
    const headers = {
      'Authorization': `Bearer ${authValues.apiToken}`,
      'Content-Type': 'application/json',
      'Fingerprint': authValues.apiFingerprint
...
const codeExamples = {
  curl: {
    1: `curl -X POST "https://develop.okd.finance/api/managed/sign-in" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{}'`,
    2: `curl -X POST "https://develop.okd.finance/api/managed/sign-up" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \\
  -H "Content-Type: application/json" \\
  -H "Fingerprint: YOUR_FINGERPRINT" \\
  -d '{}'`
...
type LoginuserformanagedIDRequest struct {

}

func loginuserformanagedid() error {
    url := "https://develop.okd.finance/api/managed/sign-in"
    
    requestData := LoginuserformanagedIDRequest{
...
func main() {
    if err := loginuserformanagedid(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`,
    2: `package main
...
type CreatesuserformanagedIDRequest struct {

}

func createsuserformanagedid() error {
    url := "https://develop.okd.finance/api/managed/sign-up"
    
    requestData := CreatesuserformanagedIDRequest{
...
func main() {
    if err := createsuserformanagedid(); err != nil {
        fmt.Printf("Error: %v\\n", err)
    }
}`
  },
  typescript: {
    1: `interface LoginuserformanagedIDRequest {

}

async function loginuserformanagedid(
  baseUrl: string,
  accessToken: string,
  data: LoginuserformanagedIDRequest
): Promise<any> {
  const response = await fetch(\`\${baseUrl}/managed/sign-in\`, {
    method: 'POST',
    headers: {
...
async function main() {
  try {
    const result = await loginuserformanagedid(
...
main();`,
    2: `interface CreatesuserformanagedIDRequest {

}

async function createsuserformanagedid(
  baseUrl: string,
  accessToken: string,
  data: CreatesuserformanagedIDRequest
): Promise<any> {
  const response = await fetch(\`\${baseUrl}/managed/sign-up\`, {
    method: 'POST',
    headers: {
      'Authorization': \`Bearer \${accessToken}\`,
      'Content-Type': 'application/json',
...
async function main() {
  try {
    const result = await createsuserformanagedid(
      'https://develop.okd.finance/api',
      'YOUR_ACCESS_TOKEN',
      {
...
function loginuserformanagedid($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/managed/sign-in';
...
function createsuserformanagedid($baseUrl, $accessToken, $data) {
    $url = $baseUrl . '/managed/sign-up';
...
try {
    ...
    $result = createsuserformanagedid(
        'https://develop.okd.finance/api',
        'YOUR_ACCESS_TOKEN',
        $data
    );
...
def loginuserformanagedid(
    base_url: str,
    access_token: str,
    data: Dict[str, Any]
) -> Dict[str, Any]:
    """No description available"""
    url = f"{base_url}/managed/sign-in"
...
def createsuserformanagedid(
    base_url: str,
    access_token: str,
    data: Dict[str, Any]
) -> Dict[str, Any]:
    """No description available"""
    url = f"{base_url}/managed/sign-up"
