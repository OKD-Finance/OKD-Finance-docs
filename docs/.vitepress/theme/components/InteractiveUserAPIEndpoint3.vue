<template>
  ...
  -d &#39;{
    &quot;profileUpdates&quot;: &quot;example_profileUpdates&quot;,
    &quot;securityAlerts&quot;: &quot;example_securityAlerts&quot;
  }&#39;</pre>
            </div>
...
async function userprofileRequest() {
  try {
    const data = {
      profileUpdates: &#39;example_profileUpdates&#39;,
      securityAlerts: &#39;example_securityAlerts&#39;,
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                ...
                <select v-model="testData.profileUpdates" class="test-input">
          ...
          <div class="form-group">
                ...
                <select v-model="testData.securityAlerts" class="test-input">
                  <option :value="true">True</option>
                  <option :value="false">False</option>
                </select>
              </div>
...
const testEndpoint = async () => {
  try {
    ...
    const requestBody = {
      profileUpdates: testData.profileUpdates,
      securityAlerts: testData.securityAlerts
    }
