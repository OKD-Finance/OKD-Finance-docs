...
async function authnotificationsRequest() {
  try {
    const data = {
      group_id: &#39;example_group_id&#39;,
      hide_read: &#39;example_hide_read&#39;,
    ...
    const response = await apiClient.get(&#39;/auth/notifications&#39;, data);
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          ...
          <div class="form-group">
                ...
                <input v-model="testData.hide_read" type="text" placeholder="example_hide_read" class="test-input" />
              </div>
          <div class="form-group">
                <label>Limit</label>
