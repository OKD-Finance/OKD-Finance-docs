          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">list of transactions</span>
              </div>
      ...
      <div class="endpoint-testing">
        ...
        <div class="test-section">
          <div class="form-group">
                ...
                <input v-model="testData.statuses" type="text" placeholder="example_statuses" class="test-input" />
              </div>
          <div class="form-group">
                <label>Coin</label>
                <input v-model="testData.coin" type="text" placeholder="example_coin" class="test-input" />
              </div>
          <div class="form-group">
                <label>Amount</label>
                <input v-model="testData.amount" type="text" placeholder="example_amount" class="test-input" />
              </div>
          <div class="form-group">
                <label>Type</label>
                <input v-model="testData.type" type="text" placeholder="example_type" class="test-input" />
              </div>
          <div class="form-group">
                <label>From</label>
