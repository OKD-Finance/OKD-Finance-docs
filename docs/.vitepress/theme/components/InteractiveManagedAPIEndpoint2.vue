...
async function managedsignupRequest() {
  try {
    const response = await apiClient.post(&#39;/managed/sign-up&#39;);
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">user was registrated</span>
              </div>
