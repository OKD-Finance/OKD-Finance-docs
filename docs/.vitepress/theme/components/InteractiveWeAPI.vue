...
// API Methods
    ...
    async ws_authorization() {
      this.loading['ws_authorization'] = true;
      this.error['ws_authorization'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/authorization`, {
          method: 'PATCH',
          headers,
        ...
        this.responses['ws_authorization'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['ws_authorization'] = err.message;
      } finally {
        this.loading['ws_authorization'] = false;
      }
    },
    async ws_external() {
      this.loading['ws_external'] = true;
      this.error['ws_external'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/external`, {
          method: 'PATCH',
          headers,
        ...
        const data = await response.json();
        this.responses['ws_external'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['ws_external'] = err.message;
      } finally {
        this.loading['ws_external'] = false;
      }
    },
    async ws_symbols() {
      this.loading['ws_symbols'] = true;
      this.error['ws_symbols'] = null;
      ...
      try {
        ...
        const data = await response.json();
        this.responses['ws_symbols'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['ws_symbols'] = err.message;
      } finally {
        this.loading['ws_symbols'] = false;
      }
    },
    async ws_unsubscribe() {
      this.loading['ws_unsubscribe'] = true;
      this.error['ws_unsubscribe'] = null;
      ...
      try {
        ...
        const data = await response.json();
        this.responses['ws_unsubscribe'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['ws_unsubscribe'] = err.message;
      } finally {
        this.loading['ws_unsubscribe'] = false;
      }
    },
    async ws_notifications() {
      this.loading['ws_notifications'] = true;
      this.error['ws_notifications'] = null;
      ...
      try {
        ...
        const response = await fetch(`${this.apiUrl}/user/notifications`, {
          method: 'PATCH',
          headers,
        ...
        const data = await response.json();
        this.responses['ws_notifications'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['ws_notifications'] = err.message;
      } finally {
        this.loading['ws_notifications'] = false;
      }
    },
    async ws_profile() {
      this.loading['ws_profile'] = true;
      this.error['ws_profile'] = null;
      ...
      try {
        ...
        const data = await response.json();
        this.responses['ws_profile'] = data;
        
        if (!response.ok) {
          throw new Error(data.message || 'Request failed');
        }
      } catch (err) {
        this.error['ws_profile'] = err.message;
      } finally {
        this.loading['ws_profile'] = false;
      }
    },
</script>
