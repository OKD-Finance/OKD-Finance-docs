...
async function wallettransactionswithdrawuuidrejectRequest() {
  try {
    const data = {
      uuid: &#39;example_uuid&#39;,
      type: &#39;example_type&#39;,
    ...
    const response = await apiClient.put(&#39;/wallet/transactions/withdraw/{uuid}/reject&#39;, data);
...
// Usage
wallettransactionswithdrawuuidrejectRequest();</pre>
            </div>
          ...
          <div class="response-examples">
            <div class="response-example">
              <div class="response-header">
                ...
                <span class="response-description">withdrawal declined</span>
              </div>
